...
import 'components/body.dart';//pacote SVG serve para colocar um icone SVG de fora 
  ...
  AppBar buildAppBar() {
    return AppBar(
      ...
      leading: IconButton(//leading icone fica na parte esquerda do appBar
        icon:SvgPicture.asset("assets/icons/back.svg", color: kTextColor,), //SvgPicture.asset("assets/icons/homem.png"),//SVG serve para colocar um icone SVG de fora 
        onPressed: (){},),
